...
const SeatLayout = () => {
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-4 sm:px-8 md:px-16 lg:px-40 py-14 md:pt-20 gap-6'>

      {/* Available Timing */}
      <div className='w-full md:w-60 bg-primary/10 border border-primary/20 rounded-lg py-6 md:py-10 h-max md:sticky md:top-32'>
        <p className='font-semibold px-6 mb-4'>Available Timing</p>
